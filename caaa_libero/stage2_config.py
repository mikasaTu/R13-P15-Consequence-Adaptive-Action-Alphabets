...
def method_definitions():
    return {
        ...
        "methods": {
            ...
            "B1_centered_covariance": "K=64 bank medoids under train-only covariance-whitened residual distance.",
            "B2_phase_residual": "Four phase-specific K=64 bank medoid sets under raw residual distance.",
